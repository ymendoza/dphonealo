...
<body>
    ...
    <!--Masthead-->
    <div class="row-masthead" class="parallax-window" data-parallax="scroll" data-image-src="<?php echo e(asset('assets/masthead.jpg')); ?>">
        <div class="container">
            <div class="row">
              <div class="col-md-2">
                  <img src="<?php echo e(asset('assets/logo.svg')); ?>" class="logo"/>
              </div>
            ...
            <div class="row">
                <div class="col-md-8 col-sm-12 col-lg-6 masthead-text">
                    <h1>Phonealo </h1>
                    <p class="sub-text">LLamadas Baratas y de Calidad</p>
                    <a href="#">Read More →</a>
                </div>
